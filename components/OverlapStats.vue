        ...
        <div class="mx-auto max-w-4xl">
          <dl class="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
            <div class="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
              ...
              <dd class="order-1 text-5xl font-bold tracking-tight text-red-600">100%</dd>
            </div>
            <div class="flex flex-col border-b border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l sm:border-r">
              ...
              <dd class="order-1 text-5xl font-bold tracking-tight text-red-600">24/7</dd>
            </div>
            <div class="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
              <dt class="order-2 mt-2 text-lg font-medium leading-6 text-gray-500">Calories</dt>
              <dd class="order-1 text-5xl font-bold tracking-tight text-red-600">100k</dd>
            </div>
          </dl>
        </div>
      </div>
